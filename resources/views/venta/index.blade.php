    ...
    <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" method="GET" action="{{ route('pago.index') }}"  role="form" id="frm-bus"  >
        <legend>Buscar alumno</legend>
            <div class="input-group">
              <input type="text" class="form-control bg-light border-0 small" name="buscar" placeholder="Buscar alumno" aria-label="Buscar" aria-describedby="basic-addon2" id="buscar" autofocus="" value="{{ request()->buscar }}" required>
